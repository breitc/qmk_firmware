...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x6(
        ...
        KC_LCTL, KC_Z,   KC_X,    KC_C,   KC_V,   KC_B,                           KC_N  , KC_M  ,KC_COMM, KC_DOT,KC_SLSH,KC_BSLASH,
                         KC_LBRC, KC_RBRC,                                                       KC_EQL ,KC_MINS,
                                         ...
                                         KC_LALT, KC_GRV,                         KC_LWIN, KC_DEL,
                                         KC_MENU, KC_CAPS,                        KC_NUM,  KC_RALT
    ),

    [_LOWER] = LAYOUT_5x6(
        _______,_______,_______,_______,_______,_______,                        _______,_______,_______,_______,_______,KC_DEL,
        _______,_______,_______,_______,_______,_______,                        _______, KC_P7 , KC_P8 , KC_P9 ,KC_PMNS,_______,
        _______,KC_HOME,KC_PGUP,KC_PGDN,KC_END ,_______,                        _______, KC_P4 , KC_P5 , KC_P6 ,KC_PPLS,_______,
    ...
    [_RAISE] = LAYOUT_5x6(
          ...
          _______,_______,KC_MPRV,KC_MPLY,KC_MNXT,_______,                        _______,KC_PGUP,KC_UP  ,KC_PGDN,KC_PSCR,_______,
